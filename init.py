...
questions_answers = {
    ...
    4: [4, "What song makes you want to get up on stage and sing your heart out?",
        [["1", "'We Rock' by Camp Rock Cast"], ["2", "'Malibu' by Miley Cyrus"], ["3", "'Begin Again' by Taylor Swift"]], False],
    ...
    8: [8, "Pick a Kardashian/Jenner", [["1", "q8a.jfif"], ["2", "q8b.jpg"], ["3", "q8c.jpg"]], True],
